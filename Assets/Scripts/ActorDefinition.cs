...
namespace NoZ.RuneHaze
{
    ...
    public class ActorDefinition : ScriptableObject
    {
        ...
        /// <summary>
        /// Instantiate an actor from this definition
        /// </summary>
        public Actor Instantiate (Vector3 position, Quaternion rotation, Transform parent)
        {
            ...
            actorTransform.position = position.ZeroY() + Vector3.up * parent.position.y;
