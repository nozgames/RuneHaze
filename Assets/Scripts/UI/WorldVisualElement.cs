...
namespace NoZ.RuneHaze.UI
{
    ...
    {
        protected static readonly LinkedList<WorldVisualElement> _elements = new();

        protected readonly LinkedListNode<WorldVisualElement> _node;
        ...
        /// <summary>
        /// Offset from transform in world coordinates
        /// </summary>
    ...
    public class WorldVisualElement<TElement> : WorldVisualElement where TElement : VisualElement, new()
    {
        ...
        public static WorldVisualElement<TElement> Alloc(Transform transform) => Alloc(Vector3.zero, transform);

        public static WorldVisualElement<TElement> Alloc (Vector3 offset, Transform transform)
        {
